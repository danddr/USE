...
#' @format A data frame obtained from a SpatRaster with 1080 rows, 2160 columns, and 5 layers, namely: wc2.1_10m_bio_4, wc2.1_10m_bio_3, wc2.1_10m_bio_14, wc2.1_10m_bio_9, wc2.1_10m_bio_15.
