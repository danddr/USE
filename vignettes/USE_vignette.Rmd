...
Create a virtual species. For details about the methodology used, see the  [vignette](http://borisleroy.com/files/virtualspecies-tutorial.html#introduction) of the **virtualspecies** R package
```{r, eval=TRUE, message=FALSE}
...
Find the optimal resolution of the sampling grid. First, made a PCA on the whole raster stack and then use the PC-scores of the first two axes to create a new spatial object. 
```{r, eval=TRUE}
